...
function initMap() {
  const mapOptions = {
    ...
    mapTypeControlOptions: {
      mapTypeIds: [
        google.maps.MapTypeId.ROADMAP // Include only the ROADMAP map type
      ]
    },
  ...
  const infoWindow = new google.maps.InfoWindow({
    content: '<h3>Interceptor 007</h3><p>Ballona Creek, LA, the United States of America</p><img src="/assets/interceptor007.png" alt="Interceptor007" style="width: 300px; height: auto;">'
  });
